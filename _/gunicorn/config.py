...
os.environ["DJANGO_SETTINGS_MODULE"] = "_.settings"
...
logconfig_dict = {
    ...
    'handlers': {
        ...
        'log_file': {
            ...
            'filename': os.path.join(settings.BASE_DIR, 'log', 'gunicorn_access.log'),
        ...
        'error_log_file': {
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': os.path.join(settings.BASE_DIR, 'log', 'gunicorn_error.log'),
            'maxBytes': 10 * 1024 * 1024,
            'backupCount': 3,
            'encoding': 'UTF-8',
        },
